...
console.log([1][1])        // Saída: 42
console.log([2])           // Saída: [ [ '3º nível, 1º item', 'olá, mundo! ], [ '3º nível, 2º item', 'Oi, mundo!' ] ]
console.log([2][0])        // Saída: [ '3º nível, 1º item', 'olá, mundo! ]
console.log([2][1][1])     // Saída: 'Oi, mundo!'

//Matrizes (arrays com duas dimensões)

// Podemso ver claramente a estrutura de uma matriz em uma tabela
...
// Podemos usar vários níveis de laços FOR para interar facilmente pela matriz
