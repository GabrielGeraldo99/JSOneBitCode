...
calcular(3, 5, somar)
console.log(somar) // Retornar a própria função 
console.log(somar(1, 1)) // Chama a função (retorna o resultado da função)

// Funções anônimas como parâmetros

// Também podemos escrever funções anônimas denro da própria chamada da high-order function
...
// Essas funções que são passadas como parâmetros geralmente são chamadas de callbacks, um exemplo comum de high-order function no javascript é a função .forEach() dos arrays
