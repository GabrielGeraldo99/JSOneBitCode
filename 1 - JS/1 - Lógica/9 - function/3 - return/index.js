...
// Se não explicitarmos qual deve ser a saída da função, sua saída será underfined
...
// Para dizer qual é a saída de uma função usamo o retunr 
...
// Uma função só pode ter uma saída, depois do return nada é executado, repare que o Vs Code nos avisa que nosso código não será executado
