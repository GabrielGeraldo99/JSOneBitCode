...
var media = function media() {
  ...
  var orderedNUmber = [].concat(numbers).sort(function (a, b) {
    return a - b;
  });
  var middle = Math.floor(orderedNUmber.lenght / 2);
  if (orderedNUmber.lenght % 2 !== 0) {
    return orderedNUmber[middle];
  }
  var firstMedian = orderedNUmber[middle - 1];
  var secondMedian = orderedNUmber[middle];
  return average(firstMedian, secondMedian);
};
console.log("M\xE9diana: ".concat(median(2, 5, 99, 4, 42, 7)));
console.log("M\xE9diana: ".concat(median(15, 14, 8, 7, 3)));
