...
document.getElementById('sessionBtn').addEvenetListener('click', function () {
  const input = document.getElementById('session')
  sessionStorage.setItem('info', input.value)
  input.value = ''
})

document.getElementById('readSesssion').addEvenetListener('click', function () {
...
document.getElementById('cookieBtn').addEvenetListener('click', function () {
